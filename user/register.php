        ...
        <a class="waves-effect waves-light btn modal-trigger" href="#mdfrmregister">Register</a>
            <!-- <div class="modal modal-fixed-footer" id="mdfrmregister"> -->
                <div class="modal-content">
                    ...
                    <form class="col s12" id="frmregister" method="POST" action="register_success.php">

                    <!-- Last Name -->
                        <div class="row">
                            <div class="input-field inline">
                                <input id="txtlname" name="txtlname" type="text" class="tooltipped" data-position="right" data-delay="50" data-tooltip="e.g Sahib">
                                <label for="last_name">Last Name</label>
                            </div>

                    <!-- First Name -->
                            <div class="input-field inline">
                                <input id="txtfname" name="txtfname" type="text" class="tooltipped" data-position="right" data-delay="50" data-tooltip="e.g Nadeem">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="txtaddress" name="txtaddress" type="text" class="tooltipped" data-position="top" data-delay="50" data-tooltip="e.g Phoenix">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="txtpostalcode" name="txtpostalcode" type="text" class="tooltipped" data-position="right" data-delay="50" data-tooltip="e.g MU-09">
                    ...
                    <div class="row">
                            <div class="input-field col s6">
                            <input id="txtpass" name="txtpass" type="password" class="tooltipped" data-position="right" data-delay="50" data-tooltip="e.g Qwert1!se">
                    ...
                    <div class="row">
                            <div class="input-field col s6">
                            <input id="txtcpass" name="txtcpass" type="password">
